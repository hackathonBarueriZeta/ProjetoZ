		...
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="row">
						<div class="form-group col-xs-12 col-md-12">
							<label for="txt_cep">Seu local de partida - CEP:</label>
							<input class="form-control input-lg" name="txt_cep" id="txt_cep" type="text" placeholder="Seu local de partida - CEP" value="13566590" required>
							<br>
							<div id="local">
